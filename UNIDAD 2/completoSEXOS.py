...
print(50 * '=')
print('Section: Training a perceptron model on the Sex dataset')
print(50 * '-')
...
#############################################################################
print(50 * '=')
print('Plotting the Sex data')
print(50 * '-')

#Asigna 1 a M y -1 a F
y = df.iloc[1:, 2].values
y = np.where(y == 'F', 1, -1)

# Extrae la altura y el peso
...
plt.scatter(X[y == 1, 0], X[y == 1, 1], color='red', marker='o', label='F')
plt.scatter(X[y == -1, 0], X[y == -1, 1], color='blue', marker='x', label='M')
